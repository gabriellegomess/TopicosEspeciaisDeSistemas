...
var x, y;
var teclado = require("prompt-sync")(); //pegar a função daquele pacote que a gente baixou (pegar o valor do teclado do usuário)
...
console.log((0, funcoes_1.calcularSoma)(x, y));
